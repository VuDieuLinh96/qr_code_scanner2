...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(OpenCamera camera, int width, int height) {
        ...
        if (camera.getFacing() == CameraFacing.FRONT) {
            ...
            SimpleLog.i(TAG, "Front google.zxing.client.android.android.com.google.zxing.client.android.camera overriden to: " + cwRotationFromNaturalToCamera);
        }
        ...
        if (camera.getFacing() == CameraFacing.FRONT) {
            SimpleLog.i(TAG, "Compensating rotation for front google.zxing.client.android.android.com.google.zxing.client.android.camera");
            cwNeededRotation = (360 - cwRotationFromDisplayToCamera) % 360;
        } else {
            cwNeededRotation = cwRotationFromDisplayToCamera;
        }
        SimpleLog.i(TAG, "Clockwise rotation from display to google.zxing.client.android.android.com.google.zxing.client.android.camera: " + cwNeededRotation);
